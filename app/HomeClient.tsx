      ...
      <section className="relative flex flex-col items-center justify-center px-6 pt-12 pb-8 text-center">
        <div className="max-w-4xl space-y-6">
          ...
          <p className="font-inter text-base font-light text-accent/60 md:text-lg">
            Explore expert wine food pairing recommendations and learn the
            principles of perfect wine and food combinations
          </p>
          {/* Pick for Me Button */}
          {/*          <div className="pt-4">
            <button
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-2 font-inter text-base font-light text-accent/70">
                    Tell us what’s in your glass and we’ll suggest dishes that
                    make it shine
                  </p>
                </div>
              </div>
            ...
            >
              <div className="relative z-10 space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-2 font-inter text-base font-light text-accent/70">
                    Share what’s on the table and we’ll help you pour a matching
                    wine
                  </p>
                </div>
              </div>
